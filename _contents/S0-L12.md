...
### Experiments
Assess the performance of LLaVA in instruction-following and visual reasoning capabilities with two primary experimental settings：
+ Multimodal Chatbot
+ ScienceQA
...
### Results
Good results from LLaVA and GPT-4, with even some surprising findings about CLIP (Figure 6)
