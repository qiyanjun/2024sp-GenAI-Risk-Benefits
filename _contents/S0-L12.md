...
### Experiments
It assesses the performance of LLaVA in instruction-following and visual reasoning capabilities with two primary experimental settings：
...
Findings about CLIP in Figure 6 is surprising as it is resistant to unseen images.
