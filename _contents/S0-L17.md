...
hyperparameter $\alpha$ is between 0.2 and 2, the larger it is the more contrast there is between the expert and
anti-expert.

It shows that the informativeness decreases as $\alpha$ increases, while the truthfulness increases. There is
