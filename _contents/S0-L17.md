...
### Outline
<img src="{{ site.baseurl }}/Lectures/S0-L17-parker/Slide2.PNG" width="80%" height="80%">
...
<img src="{{ site.baseurl }}/Lectures/S0-L17-parker/Slide3.PNG" width="80%" height="80%">

### Context
<img src="{{ site.baseurl }}/Lectures/S0-L17-parker/Slide5.PNG" width="80%" height="80%">
...
### Unwanted Knowledge
<img src="{{ site.baseurl }}/Lectures/S0-L17-parker/Slide6.PNG" width="80%" height="80%">
...
<img src="{{ site.baseurl }}/Lectures/S0-L17-parker/Slide7.PNG" width="80%" height="80%">
...
<img src="{{ site.baseurl }}/Lectures/S0-L17-parker/Slide8.PNG" width="80%" height="80%">
...
<img src="{{ site.baseurl }}/Lectures/S0-L17-parker/Slide9.PNG" width="80%" height="80%">
...
<img src="{{ site.baseurl }}/Lectures/S0-L17-parker/Slide10.PNG" width="80%" height="80%">
For evaluation, the authors primarily use metrics of reliability, generalization, and locality.

#### Current Methods
<img src="{{ site.baseurl }}/Lectures/S0-L17-parker/Slide12.PNG" width="80%" height="80%">
...
<img src="{{ site.baseurl }}/Lectures/S0-L17-parker/Slide13.PNG" width="80%" height="80%">
The authors present this table to compare the current methods and specify additional attributes of their approaches. 

<img src="{{ site.baseurl }}/Lectures/S0-L17-parker/Slide15.PNG" width="80%" height="80%">
...
<img src="{{ site.baseurl }}/Lectures/S0-L17-parker/Slide16.PNG" width="80%" height="80%">
...
<img src="{{ site.baseurl }}/Lectures/S0-L17-parker/Slide17.PNG" width="80%" height="80%">
This slide shows the results of existing methods on three metrics of the dataset: reliability, generalization, and locality. 

<img src="{{ site.baseurl }}/Lectures/S0-L17-parker/Slide18.PNG" width="80%" height="80%">
...
<img src="{{ site.baseurl }}/Lectures/S0-L17-parker/Slide19.PNG" width="80%" height="80%">
